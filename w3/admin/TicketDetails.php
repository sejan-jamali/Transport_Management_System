...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="TicketDetails.php"><i class="fa fa-link"></i> <span>Ticket Status</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-sm-12">
          <h1>Ticket Details<a href="TicketDetails.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Back</a></h1>
           ...
           <tbody>
             <?php
                ...
                if(isset($_POST['submit'])){
                  $date=$_POST['date'];
                  $q="SELECT * FROM `ticket` WHERE `date`='$date'";
                  ...
                  ?>
                     <tr>
                      ...
                      <td><?php echo $row['t_payment'] ?></td>
                      <td><?php echo $row['payment_status'] ?></td>
                      <td>
                        <a href="TicketUpdate.php?id=<?php echo $row['t_id'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Payment</a>
                        <a onclick="return confirm('Are Yur Sure?To delete!')" href="TicketDelet.php?id=<?php echo $row['t_id'] ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete</a>
                      </td>
                     </tr>
                  <?php
                    }
