...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
          <h1>Ticket Details<a href="account.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Back</a></h1>
           ...
           <tbody>
             <?php
                ...
                //if(isset($_POST['submit'])){
                  //$date=$_POST['date'];
                  $id=$_SESSION['aid'];
                  $q="SELECT * FROM `ticket` WHERE `u_id`='$id'";
